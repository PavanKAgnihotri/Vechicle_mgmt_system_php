...
<div id="add" class="tabcontent">
    ...
    <div class="tab1">
        <button class="tablinks1" onclick="opentype1(event, '2wheel')" id="defaultOpen1"> <p>Two Wheelers</p></button>
...
<div id="2wheel" class="tabcontent1">  
    <h2 style="color:green; position:relative;left:20%;">Enter the Details for Two Wheeler Vehicles </h2><br>
...
<p style="color:blue;">Enter Vehicle Name :-</p> 
  ...
  <br>
   <br>
  <input class="button" type="submit" name="add2wheel" value="Add Vehicle">
     ...
     <?php
            ...
            $sql2 = "INSERT INTO vehicles VALUES('two wheeler','$vbrand','$vname','$engcc','$vmil','$vspeed','$vweight','$vpower','$vlt','$vprice','$vlink',' ','$vstock');";
            if ($conn->query($sql2) === TRUE) {
                echo '<p style="color:green;padding:10pt;"> Two Wheeler Added Successfully !!! </p> '; 
            }
