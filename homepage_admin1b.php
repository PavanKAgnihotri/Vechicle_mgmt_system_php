...
<div id="add" class="tabcontent">
      ...
      <button class="tablinks1" onclick="opentype1(event, '3wheel')" id="defaultOpen1" ><p>Three Wheelers</p></button>
      <form method="post" action="homepage_admin1c.php"><button class="tablinks1" onclick="opentype1(event, '4wheel')"><p>Four Wheelers</p></button></form>
    </div>     
    

   <div id="3wheel" class="tabcontent1">  
       <h2 style="color:green; position:relative;left:20%;">Enter the Details for Three Wheeler Vehicles </h2><br>
       <form method="post">
...
<p style="color:blue;">Enter Vehicle Name :-</p> 
  ...
  <br>
   <br>
  <input class="button" type="submit" name="add3wheel" value="Add Vehicle">
   </form>
        <?php
            ...
            $sql2 = "INSERT INTO vehicles VALUES('three wheeler','$vbrand','$vname','$engcc','$vmil','$vspeed','$vweight','$vpower','$vlt','$vprice','$vlink',' ','$vstock');";
            if ($conn->query($sql2) === TRUE) {
                echo '<p style="color:green;padding:10pt;"> Three Wheeler Added Successfully !!! </p> '; 
            }
